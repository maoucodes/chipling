...
const ModuleGrid: FC<ModuleGridProps> = ({ 
  ...
  return (
    <div className="container mx-auto px-container animate-fade-in max-w-7xl flex flex-col h-full overflow-hidden">
      <div className="sticky top-0 bg-background/95 backdrop-blur-sm py-4 z-50 border-b border-border/50 flex-shrink-0">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4">
          <h2 className="text-xl sm:text-2xl font-bold truncate max-w-full">
          ...
          {currentModuleIndex < modules.length - 1 && onNextModule && (
            <button 
              ...
              className="flex items-center gap-2 text-sm bg-primary/10 border border-primary/20 rounded-md px-3 py-2 hover:bg-primary/20 transition-colors whitespace-nowrap focus-ring"
            >
